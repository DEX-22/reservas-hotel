...
<?php
$recorrido = ControladorRecorridoPueblo::ctrRecorridoPueblo();
					...
					<ul class="slide-area">
						...
						<li>
							<div class="grid-container pt-4 pb-1 pb-lg-3 px-0 px-lg-5">
								<div class="grid-item">
									<img src="<?php echo $value['foto_peq']; ?>" class="img-fluid" width="100%">
								</div>
								<div class="grid-item">
								...
								<div class="grid-item d-none d-lg-block">
									<img src="<?php echo $value['foto_grande']; ?>" class="img-fluid" width="100%">
								</div>
							</div>
						</li>			
						<?php endforeach ?>
